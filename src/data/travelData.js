// ============================
// COMPLETE DATA FROM rajasthangauravtravels.com
// ============================

// ---- CONTACT INFO ----
export const contactInfo = {
  email: "rajasthangauravtravels@gmail.com",
  phone: "+91 8854913030",
...
export const aboutUs = {
  ...
  stats: [
    { icon: "🏨", count: 245, label: "Trips" },
    { icon: "👥", count: 15, label: "Staffs" },
    { icon: "🚕", count: 25, label: "Cabs" }
  ],
  mission: {
    title: "Our Mission",
...
export const services = [
  {
    ...
    description: "Unlock India's Wonders with Our Exclusive Rental Services. Based in the vibrant city of Jaipur, we specialize in turning your travel dreams into reality."
  },
  {
    id: "raj-darshan",
    icon: "🏰",
    title: "Raj Darshan",
    description: "Go deep into the land of the Rajputs. Explore majestic forts, dream-like palaces, harlequin bazaars, and time-warped museums."
  },
  {
    id: "luxury-car",
    icon: "🚘",
    title: "Luxury Car Rentals",
    description: "Embark on your travels with a touch of class. Choose from Chic Sedans, Spacious SUVs, and High-End Vehicles for an unforgettable experience."
  },
  {
    id: "bus-rental",
    icon: "🚌",
    title: "Group Travel: Bus Rentals",
    description: "Comfortable Standard Buses for city tours and short trips. Luxurious Coaches equipped with plush seating, advanced entertainment for longer journeys."
  },
  {
    id: "tempo-traveller",
    icon: "🚐",
    title: "Tempo Traveller Rentals",
    description: "Premium Tempo Travellers with reclining seats and ample legroom. Standard Tempo Travellers reliable for extended journeys and group travel."
  }
];

// ---- CAR RENTAL SECTION ----
export const carRental = {
  title: "Car Rental Jaipur",
  description: "Rajasthan Gaurav Travels provides a large fleet of cars, taxis for local city sightseeing and for outstation trips from Jaipur. When planning for a tour with family, friends, or solo, one thing that you must not miss is renting a car. Out of innumerable car rental service providers in Jaipur, Rajasthan Gaurav Travels is a name known for reliable and safe travel facilities.",
  useCases: [
    "Sightseeing and exploring – Jaipur forts and palaces, Day trips from Jaipur",
    "Business travel – Meetings and conferences",
    "Family outings",
    "Weddings and events",
...
export const luxuryTravel = {
  title: "Discover A Brand Luxurious Tour",
  description: "An opulent journey through Rajasthan with our brand new luxurious tour, where indulgence meets tradition in every exquisite detail.",
  youtubeEmbed: "https://www.youtube.com/embed/xBjhSNrB2Og"
};

// ---- RAJ DARSHAN (7 Things to do) ----
export const rajDarshan = {
  title: "7 Things To Do in Rajasthan",
  subtitle: "Go Deep Into the Land of the Rajputs",
  intro: "A traveller is transformed into an explorer in Rajasthan what with the majestic forts, dream-like palaces, harlequin bazaars, and time-warped museums that pepper this desert state. When it comes to things to do in Rajasthan, any traveller is spoiled for choice.",
  activities: [
    {
      ...
      places: [
        ...
        { name: "Palace Museum, Alwar", desc: "Houses the swords of Mughal emperors Akbar and Aurangzeb, a rare manuscript recording the life of Emperor Babur, miniatures, and Ragamala paintings." },
        { name: "Mehrangarh Museum, Jodhpur", desc: "Gives you a glimpse of courtly life in Jodhpur with artefacts ranging from the 17th to the 19th century." },
        { name: "Vintage Car Museum, Udaipur", desc: "Houses retro vehicles from a 1938 Cadillac to a 1934 Rolls Royce Phantom. All 22 cars on display are a car enthusiasts' dream!" }
      ]
    },
    {
      ...
      places: [
        ...
        { name: "Sonar Quila, Jaisalmer", desc: "UNESCO World Heritage Site with seven-storied Maharaja Mahal, Diwan-i-Khas, and Diwan-i-Am." },
        { name: "Mehrangarh Fort, Jodhpur", desc: "Sitting on a 125m hill, with Sheesh Mahal's mirror-worked walls and Takhat Vilas fresco-covered mansion." },
        { name: "Kumbhalgarh Fort, Udaipur", desc: "The most impregnable fort in Rajasthan with a 36m wall, birthplace of Maharana Pratap." }
      ]
    },
    {
...
export const destinations = [
  {
    ...
    highlights: [
      { name: "City Palace", desc: "An architectural marvel combining the best of Rajasthani and Mughal influences. Wander through elegant courtyards, lush gardens, and majestic halls." },
      { name: "Hawa Mahal", desc: "A stunning architectural marvel that captivates with its intricate design and rich history. Its exterior beauty alone is enough to leave visitors in awe." },
  ...
  },
  {
    ...
    highlights: [
      { name: "Mehrangarh Fort", desc: "Looming over the Blue City on a 125m hill, with Sheesh Mahal's mirror-worked walls and Takhat Vilas." },
  ...
  },
  {
    ...
    highlights: [
      { name: "City Palace", desc: "The grand City Palace of Udaipur, overlooking Lake Pichola." },
      { name: "Jagdish Temple", desc: "An ancient Hindu temple known for its beautiful carvings." },
      { name: "Lake Pichola & Boat Ride", desc: "Enjoy a serene boat ride on the crystal waters of Lake Pichola." },
      { name: "Saheliyon Ki Bari", desc: "A beautiful garden with fountains and marble elephants." },
  ...
  },
  {
    ...
    highlights: [
      { name: "Sonar Quila (Golden Fort)", desc: "UNESCO World Heritage Site with seven-storied Maharaja Mahal." },
      { name: "Sam Sand Dunes", desc: "Experience a magical desert safari on the golden sand dunes." },
  ...
  },
  {
    ...
    highlights: [
      { name: "Nakki Lake", desc: "A serene lake surrounded by hills, perfect for boating and sunset views." },
      { name: "Dilwara Temples", desc: "Exquisite Jain temples famous for their extraordinary marble carvings." },
  ...
  },
  {
    ...
    highlights: [
      { name: "Pushkar Lake", desc: "A sacred lake with 52 bathing ghats, believed to wash away sins." },
      { name: "Brahma Temple", desc: "One of the very few existing temples dedicated to the Hindu creator-god Brahma." },
  ...
  },
  {
    ...
    highlights: [
      { name: "Tiger Safari", desc: "Embark on an exciting jeep safari to spot the majestic Bengal tiger." },
      { name: "Ranthambore Fort", desc: "A formidable 10th-century fort offering panoramic views of the park." },
  ...
  },
  {
    ...
    highlights: [
      { name: "The Great Wall", desc: "Walk along the 36km long fortification, the second longest in the world." },
      { name: "Badal Mahal", desc: "The highest palace in the fort offering spectacular views of the Aravalli range." },
